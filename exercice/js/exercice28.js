//Exercice 28
//Sujet créer le jeux du morpion en ligne de commande
...
while(!fin && nbCel > 0){ //tant que le jeux n'est pas finit (fin!false) on continu à jouer
    var positionOk = false; //vérification false si tout est ok 
